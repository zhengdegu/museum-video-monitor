...
EOF
    ...
    echo "[1/5] MySQL data exists, skipping init."
fi

# ---- 2. Ensure directories ----
echo "[2/5] Ensuring data directories..."
mkdir -p /var/lib/mysql /data/minio /data/etcd /var/lib/milvus
mkdir -p /app/data/videos /app/data/frames /app/models
mkdir -p /var/log/supervisor
chown -R mysql:mysql /var/lib/mysql

# ---- 3. Remove stale nginx default config ----
...
echo "=========================================="
echo "[5/5] Launching supervisord..."
