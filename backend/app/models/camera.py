from sqlalchemy import Column, Integer, String, SmallInteger, DateTime, ForeignKey, func
...
class Camera(Base):
    ...
    room_id = Column(Integer, ForeignKey("museum_storage_room.id"), nullable=False, comment="所属库房")
