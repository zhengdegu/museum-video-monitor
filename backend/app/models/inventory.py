from sqlalchemy import Column, BigInteger, Integer, String, Text, SmallInteger, Date, DateTime, ForeignKey, func
...
class CollectionMovement(Base):
    ...
    id = Column(BigInteger, primary_key=True, autoincrement=True)
    collection_id = Column(BigInteger, ForeignKey("museum_collection.id"), nullable=False)
